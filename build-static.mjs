...
const [html, p1, p2, p3, p4, stability, compat] = await Promise.all([
...
console.log('Diagnostico Facil built in robust manual current-view mode: no automatic catalog, school, source or Power BI navigation.');
