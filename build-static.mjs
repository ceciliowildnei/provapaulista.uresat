...
const [html, compat, sessions, bootstrap] = await Promise.all([
...
console.log('Diagnostico Facil static build ready with connector compatibility, stable sessions and automatic school catalog bootstrap.');
