...
const [html, manual, stability, compat, sessions, bootstrap, pdaFix] = await Promise.all([
...
console.log('Diagnostico Facil static build ready in manual current-view capture mode. No automatic school/source navigation.');
